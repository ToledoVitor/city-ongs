        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "document_type",
                    models.CharField(
                        choices=[("AJUSTE", "Ajuste"), ("EMPENHO", "Empenho")],
                        max_length=7,
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["contract", "document_type", "-built_at"],
                        name="audesp_aude_contrac_1ec866_idx",
                    )
                ],
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(
                            models.Q(
                                ("budget_commitment__isnull", False),
                                ("document_type", "EMPENHO"),
                            ),
                            models.Q(
                                ("budget_commitment__isnull", True),
