...
class PassOn8PDFExporter:
    ...
    def _draw_header(self):
        ...
        self.pdf.multi_cell(
            ...
            "ANEXO RP-08 - REPASSES AO TERCEIRO SETOR DEMONSTRATIVO INTEGRAL DAS RECEITAS E DESPESAS TERMO DE PARCERIA",
            align="C",
            new_x=XPos.LMARGIN,
            new_y=YPos.NEXT,
        )
    ...
    def _draw_documents_table(self):
        ...
        table_data = [
            ...
            [
                f"{contract.name}",  # TODO confirmar campo
                f"{format_into_brazilian_date(contract.start_of_vigency)}",  # TODO após criar campo
