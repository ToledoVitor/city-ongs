...
class PassOn9PDFExporter(CertificationTermPDFExporter):
    def __init__(self, contract, start_date, end_date, responsibles=None):
        ...
        self.labels = TermLabels(
            header_title="ANEXO RP-09 - TERMO DE CIÊNCIA E DE NOTIFICAÇÃO",
            header_subtitle="(REPASSES AO TERCEIRO SETOR - TERMO DE COLABORAÇÃO/FOMENTO)",
            certainty_a_text=(
    ...
    def _info_lines(self) -> list[str]:
        ...
        return [
            ...
            f"**TERMO DE COLABORAÇÃO/FOMENTO N° (DE ORIGEM):** {self.contract.name}",
