...
class PassOn9PDFExporter:
    ...
    def _draw_header(self):
        ...
        self.pdf.cell(
            0,
            0,
            "ANEXO RP-09 - TERMO DE CIÊNCIA E DE NOTIFICAÇÃO",
            align="C",
            new_x=XPos.LMARGIN,
            new_y=YPos.NEXT,
        )
    ...
    def _draw_informations(self):
        self.pdf.cell(
            text="**ÓRGÃO/ENTIDADE PÚBLICO(A):** Prefeitura Municipal de Várzea Paulista",
            markdown=True,
            h=self.default_cell_height,
        )
        self.pdf.ln(4)
        self.pdf.cell(
            text="**ORGANIZAÇÃO DA SOCIEDADE CIVIL PARCEIRA:** Associação Comunidade Varzina - Eco & Vida (Meio Ambiente)",
            markdown=True,
            h=self.default_cell_height,
        )
        self.pdf.ln(4)
        self.pdf.cell(
            text="**TERMO DE COLABORAÇÃO/FOMENTO N° (DE ORIGEM):** 10/2023",
            markdown=True,
            h=self.default_cell_height,
        )
        self.pdf.ln(4)
    ...
    def _draw_partner_authority(self):
        self.__set_helvetica_font(font_size=8, bold=True)
        self.pdf.cell(
