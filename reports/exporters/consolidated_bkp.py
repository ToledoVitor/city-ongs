...
class ContractPDFExporter:
    ...
    def handle(self):
        self._draw_bank_statement()
        self._draw_general_vision()
        self._draw_table()

        return self.pdf

    def _draw_bank_statement(self):
        # bs_pdf, bs_data, bs_col_widths, bs_headings_style
        if bs_data != []:
            with pdf.table(
    ...
    if data != []:
        headings_style = FontFace(
            "Helvetica", "B", size_pt=6, fill_color=(233, 234, 236)
        )
