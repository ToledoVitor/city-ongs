...
@dataclass
class PassOn7PDFExporter(CommonPDFExporter):
    """Exporter for Pass On 7 PDF report."""
    ...
    def _draw_header(self) -> None:
        ...
        self.pdf.cell(
            0,
            0,
            "ANEXO RP-07 - TERMO DE CIÊNCIA E DE NOTIFICAÇÃO",
            align="C",
            new_x=XPos.LMARGIN,
            new_y=YPos.NEXT,
        )
        ...
        self.pdf.cell(
            0,
            10,
            "(REPASSES AO TERCEIRO SETOR - TERMOS DE PARCERIA)",
            align="C",
            new_x=XPos.LMARGIN,
            new_y=YPos.NEXT,
        )
    ...
    def _draw_informations(self) -> None:
        ...
        self.pdf.cell(
            text=(
                f"**ENTIDADE PARCEIRA:** {self.contract.hired_company} "
                f"({self.contract.area.name})"
            ),
            markdown=True,
            h=self.default_cell_height,
        )
        ...
        self.pdf.cell(
            text=(
                f"**TERMO DE PARCERIA N° (DE ORIGEM):** "
        ...
        self.pdf.ln(4)
        self.pdf.cell(
            text="**ADVOGADO(S) / Nº OAB / E-MAIL(4): ** ",  # TODO Criar campo "advogados"
            markdown=True,
            h=self.default_cell_height,
        )
        self.pdf.ln(10)
    ...
    def _draw_notification(self) -> None:
        ...
        self.pdf.multi_cell(
            text=(
                ...
                f"Legislativo parte do Tribunal de Contas do Estado de São Paulo([{self.government_link}]"
                f"({self.government_link})), em conformidade com o artigo 90 da Lei "
                f"Complementar nº 709 de 14 de janeiro de 1993 iniciando-se a partir "
                f"de então a contagem dos prazos processuais conforme regras do Código "
                f"de Processo Civil;"
            ),
            markdown=True,
            w=190,
    ...
    def _draw_public_authority(self) -> None:
        """Draw the public authority section."""
