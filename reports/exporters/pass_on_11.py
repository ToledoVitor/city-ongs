...
class PassOn11PDFExporter:
    ...
    def _draw_informations(self):
        ...
        self.pdf.cell(
            text=f"**ÓRGÃO PÚBLICO CONVENENTE:** {self.accountability.contract.organization.city_hall.name}",
            markdown=True,
            h=self.default_cell_height,
        )
        self.pdf.ln(4)
        self.pdf.cell(
            text=f"**ENTIDADE CONVENIADA:** {self.accountability.contract.organization.name}",
            markdown=True,
            h=self.default_cell_height,
        )
        self.pdf.ln(4)
        self.pdf.cell(
            text=f"**TERMO DE CONVÊNIO N°(DE ORIGEM):** {self.accountability.contract.name}",
            markdown=True,
            h=self.default_cell_height,
        )
        self.pdf.ln(4)
    ...
    def _draw_conclusion_signature_owner(self):
        ...
        self.pdf.ln(4)
        self.pdf.cell(
            text=f"PELO ÓRGÃO PÚBLICO CONVENENTE:",
            h=self.default_cell_height,
        )
        self.pdf.ln(4)
        self.__set_helvetica_font(font_size=8, bold=False)
    ...
    def _draw_account_signature_owner(self):
        ...
        self.pdf.ln(4)
        self.pdf.cell(
            text=f"PELA ENTIDADE CONVENIADA:",
            h=self.default_cell_height,
        )
        self.pdf.ln(4)
        self.__set_helvetica_font(font_size=8, bold=False)
