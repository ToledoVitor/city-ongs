...
class PassOn13PDFExporter:
    ...
    def _draw_informations(self):
        ...
        self.pdf.ln(4)
        self.pdf.cell(
            text=f"**AUXÍLIO/SUBVENÇÃO/CONTRIBUIÇÃO:** {self.accountability.contract.name}",
            markdown=True,
            h=self.default_cell_height,
        )
        self.pdf.ln(4)
        self.pdf.cell(
            text=f"**N° DA LEI AUTORIZADORA: {self.accountability.contract.law_num}**",
            markdown=True,
            h=self.default_cell_height,
        )
        self.pdf.ln(4)
        ...
        self.pdf.ln(4)
        self.pdf.cell(
            text=f"**VALOR REPASSADO (1):** {format_into_brazilian_currency(self.accountability.contract.total_value)}",
            markdown=True,
            h=self.default_cell_height,
        )
        self.pdf.ln(4)
    ...
    def _draw_conclusion_signature_owner(self):
        ...
        self.pdf.ln(4)
        self.pdf.cell(
            text=f"PELO ÓRGÃO PÚBLICO CONCESSOR:",
            h=self.default_cell_height,
        )
        self.pdf.ln(4)
        self.__set_helvetica_font(font_size=8, bold=False)
    ...
    def _draw_account_signature_owner(self):
        ...
        self.pdf.ln(4)
        self.pdf.cell(
            text=f"PELA ENTIDADE BENEFICIÁRIA:",
            h=self.default_cell_height,
        )
        self.pdf.ln(4)
        self.__set_helvetica_font(font_size=8, bold=False)
