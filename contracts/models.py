...
class Contract(models.Model):
    ...
    total_value = models.DecimalField(
        verbose_name="Valor do contrato", decimal_places=2
    )
...
class ContractGoal(models.Model):
    ...
    status = models.CharField(
        verbose_name="Status", choices=StatusChoices, default=StatusChoices.DRAFT
    )
...
class ContractItem(models.Model):
    name = models.CharField(verbose_name="Item", max_length=128)
    description = models.CharField(verbose_name="Descrição", max_length=128)
    total_expense = models.DecimalField(verbose_name="Despesa total", decimal_places=2)
