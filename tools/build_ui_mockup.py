...
<!-- GENERATED by tools/build_ui_mockup.py — do not edit by hand.
     ...
     If you are an agent: OPEN this in a browser, don't read it as text. It is
     ~16k tokens and almost all of that is the stylesheet you can read at its
     source, templates/ui/_styles.html. The value here is the rendered page. -->
